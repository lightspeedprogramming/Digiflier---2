  ...
  <div class="row">
    <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="footer-useful-link footer-hedding mb-20">
        <h4 class="text-white mb-30 mt-10">Contact Us</h4>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="footer-useful-link footer-hedding mb-20">
        <h4 class="text-white mb-30 mt-10">Services</h4>
        <ul>
          <li><a href="mobile-app-development.php">Mobile App Development</a></li>
          <li><a href="mobile-app-designing.php">Mobile App Designing</a></li>
          <li><a href="mobile-app-hosting.php">Mobile App Hosting Service</a></li>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="footer-useful-link footer-hedding mb-20">
        ...
        <ul>
          ...
          <li><a href="pay-per-click-service.php">Pay Per Click Service</a></li>
          <li><a href="content-marketing-service.php">Content Marketing Service</a></li>
          <li><a href="email-marketing-service.php">Email Marketing Service</a></li>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="footer-useful-link footer-hedding mb-20">
        <h4 class="text-white mb-30 mt-10">Useful Link</h4>
        <ul>
