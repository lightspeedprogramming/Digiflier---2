...
<section class="about white-bg page-section-ptb">
 <div class="container">
  <div class="row">
    <div class="col-lg-6 col-md-6">
     <div class="custom-content-2 pt-70">
      <h1 class="mb-15 text-blue">What should I use as a domain name?</h1>
  ...
  <div class="row">
    <div class="col-lg-6 col-md-6">
     <div class="custom-content-2 pt-70">
      <h1 class="mb-15 text-blue">Domain Name Registration and Privacy</h1>
  ...
  <hr style="height:40px;width:100%;display:block;clear:both;border:0 none;">
    ...
    <div class="row">
          ...
          <div class="col-lg-12 col-md-12">
            <div class="who-we-are-right">
              <p class="mt-10 text-justify">Precision design, responsive ready, full shortcodes design, perfect portfolio, unique blog layout and many many options for you so grab The Corps as soon as possible because it might change your way of presentation with its look & feature.Precision design, responsive ready, full shortcodes design, perfect portfolio, unique blog layout and many many options for you so grab The Corps as soon as possible because it might change your way of presentation with its look & feature.</p>
