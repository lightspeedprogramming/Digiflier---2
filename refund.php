...
<section class="inner-intro bg-2-my ">
  <div class="container">
     <div class="row text-center intro-title">
            <h1 class="text-blue">Refund Policy</h1>
  ...
  <div class="container">
    <div class="row">
     <div class="col-lg-12 col-md-12">
      ...
      <h4 class="text-blue mt-30">HOW LONG DOES THE REFUND INQUIRY PROCESS TAKE?</h4>
                            
      <ul>
        <li><i class="fa fa-angle-right"></i>Refund inquiry takes about 3-4 business days.</li>
        <li><i class="fa fa-angle-right"></i> Customer must follow the above terms and conditions for full refund.</li>
      </ul>

      <h4 class="text-blue mt-30">WHAT IS THE METHOD USED FOR REFUNDING?</h4>
       
      <ul>
          <li><i class="fa fa-angle-right"></i>If the request for a refund is found justified and valid, then the refund will be made directly to the customer through the medium that was used at the time of purchase.</li>
      </ul>      
