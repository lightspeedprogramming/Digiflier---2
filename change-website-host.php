              ...
              <div class="row">
                <div class="col-md-12 text-center">
                 <div class="slider-1">
                    ...
                    <h1 class="animated8 text-white">Change Website Host</h1>
  ...
  <div class="row">
    ...
    <div class="col-lg-12 col-md-12">
     <div class="custom-content-2 pt-55">
        <h5 class="mb-15 text-blue">Find a hosting company that matches your needs</h5>
    ...
    <div class="col-lg-12 col-md-12">
     <div class="custom-content-2 pt-55">
        <h5 class="mb-15 text-blue">Select the location of the Server carefully</h5>
    ...
    <div class="col-lg-12 col-md-12">
     <div class="custom-content-2 pt-55">
        <h5 class="mb-15 text-blue">Upload the website on the new host & test it</h5>
    ...
    <div class="col-lg-12 col-md-12">
     <div class="custom-content-2 pt-55">
        <h5 class="mb-15 text-blue">Change your DNS records</h5>
    ...
    <div class="col-lg-12 col-md-12">
     <div class="custom-content-2 pt-55">
        <h5 class="mb-15 text-blue">Keep both servers live for 1 or 2 days</h5>
